...
while(play):
	...
	correct_choice = random.choice(['right', 'left'])
	if choice.lower() != correct_choice:
	...
	correct_choice = random.choice(['swim', 'wait'])
	if choice.lower() != correct_choice:
	...
	correct_choice = random.choice(colors)
	if choice.lower() != correct_choice:
		
		colors.remove(correct_choice)
